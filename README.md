...
Our own flavor of DDRace (Modded by JSaurusRex to support 100hz), a Teeworlds mod. See the [website](https://ddnet.org) for more information.
(This 100hz mod is not supported / does not support normal servers, you might get banned / blacklisted on them)
